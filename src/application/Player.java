...
public class Player {
	...
	/*
	 * public void checkShot(Player player2){ int[] shot = shoot(); int shotX =
	 * shot[0]; int shotY = shot[1]; if(player2.playerField.getField()[shotX][shotY]
	 * == 's'){ System.out.println("Hit"); opponentField.hitMark(shot);
	 * player2.playerField.hitMark(shot); } else
	 * if(player2.playerField.getField()[shotX][shotY] == '0'){
	 * System.out.println("Miss"); opponentField.missMark(shot);
	 * player2.playerField.missMark(shot); } else{
	 * System.out.println("Already hitted"); } }
	 */
}
